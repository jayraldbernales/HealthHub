<?php
    ...
    $user = ($_SESSION['user']);
    $Assist = include('../Database/show-Assist.php');
            ...
            <div class="overlay">
                ...
                <div class="content">
                    <div class="clinichead">
                        <h1 class="cs2"><i class="fa-solid fa-list" style="color: #ffffff;"></i> ASSISTED PATIENTS</h1>
                        <div class="Add">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <tr>
                                            <td class="Id"><?= $assist['date']?></td>
                                            <td class="FullName"><?= $assist['fullname']?></td>
                                            <td class="medicine_name"><?= $assist['role']?></td>
                                            <td class="dosage"><?= $assist['complaint']?></td>
                                            <td class="frequency"><?= $assist['treatment']?></td>
                                            <td class="start_date"><?= $assist['name']?></td>
                                            <td class="end_date"><?= $assist['frequency']?></td>
                                        </tr>
                                    <?php }?>                                    
                                </tbody>
                            </table>
